                            ...
                            <div class="card-body">
                                ...
                                <form id="FrmCategoria">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-sm-3 col-12">
                                            <button type="submit" id="btnBuscarProducto" class="btn btn-primary btn-xs mr-3">
                                                <i class="fa fa-search" aria-hidden="true"></i>BUSCAR
                                            </button>
                                            <button type="button" id="btnAbrirNProducto" class="btn btn-primary btn-xs">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-12">
                                        <select name="sizePageProducto" id="sizePageProducto" class="form-control form-control-sm">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <nav>
                                            <ul id="paginatronProducto" class="pagination pagination-sm justify-content-end">
